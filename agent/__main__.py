...
async def init(request: Request): # dict[Literal["dynamic_variables", "conversation_config_override"], dict[str, str | dict[str, dict[str, str | dict[str, str]]]]]:
    ...
    if last_commitment:
        output["conversation_config_override"]["agent"]["first_message"] = f"Hi, {last_commitment['firstName']}, how can I help you today?  How did things go with {last_commitment['firstName']}?"
